...
import { Box, Flex, FormLabel, FormGuideline } from '@cap-collectif/ui';
    ...
    return (
        <Box as="form" maxWidth="40%" margin="auto">
            ...
            <FormControl name="holiday-pictures" control={control} isRequired>
                ...
                <FieldInput type="uploader" name="holiday-pictures" control={control} multiple />
            </FormControl>

            <FormControl name="sober" control={control} isRequired>
                <FieldInput type="checkbox" name="sober" control={control} id="sober-checkbox">
                    Are you sober ?
                </FieldInput>
            </FormControl>
            ...
            <FormControl name="happy" control={control} isRequired>
                <Flex direction="row" align="center">
                    <FieldInput type="switch" name="happy" control={control} id="happy-switch">
                        Are you happy ?
                    </FieldInput>
                </Flex>
            </FormControl>
